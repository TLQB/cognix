...
const (
	...
	keyWWrap = "45f8ac1e1de14397" // Log1 uuid-wrap payload
	keyWDC   = "87f879f135f27da7" // decrypts the server's DeviceConfig blob

	cloudauthURL = "https://cloudauth-device-dualstack.ap-southeast-1.aliyuncs.com/"
	duaneID      = "DuaneAprqkYsF3nt1yjK29Bf"       // cloudauth AccessKeyId
	duaneSecret  = "DuanemHmyeE6LXCC46sJEDUw5DTlSZ" // + "&" appended for HMAC
	...
	bridgeAccessKey = "LTAI5tSEBwYMwVKAQGpxmvTd"
	bridgeSecretKey = "YSKfst7GaVkXwZYvVihJsKF9r89koz"
)
