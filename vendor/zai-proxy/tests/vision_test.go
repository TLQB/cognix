...
// TestModelsCappedWithArchitecture (upstream) is intentionally not ported: it
// exercises the enriched /v1/models architecture fields, a separate feature of
// the upstream vision commit that this fork does not ship. Vision itself is
// fully covered by the E2E tests below.
